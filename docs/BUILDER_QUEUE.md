...
> **Last updated:** 2026-06-21 (Builder — **T CLAIMED 🔨** — control-strip UI + keyboard T-F/D5 on
> `feat/apple2-control-strip`, the final planned surface-UI row.) (Planner — **FINAL surface-UI row T PLANNED** — the control strip + keyboard
