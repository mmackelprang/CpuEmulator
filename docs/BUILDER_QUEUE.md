...
> **Last updated:** 2026-06-21 (Builder — **CPM-2 claimed (🔨)** on `feat/apple2-cpm-2-control-port-open-bus` from green main @ `8d33b30`. `SoftCardControlPort.Read()` → open-bus, no toggle.) Prior Coordinator log:
